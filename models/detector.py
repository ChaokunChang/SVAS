...
class YOLOv5(BaseModel):
    def __init__(
        self, model_type="yolov5x", long_side=416, thr=0.25, device="cpu", fp16=False
    ):
...
if __name__ == "__main__":
    ...
    det = YOLOv5(model_type="yolov5x", long_side=416, device="cuda:0", fp16=False)
    det.benchmark(image_path, batch_size=32)
