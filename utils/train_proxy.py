...
if __name__ == "__main__":
    ...
    cached_gt_path = get_label_path(opt)
    ...
    partiton_dir = osp.join(get_video_meta_home(opt), "partition")
    ...
    ckpt_final_path = os.path.join(ckpt_dir, "proxy_final.pt")
    ...
    if opt.test:
        ...
        train(model, lr, num_epochs, train_loader, ckpt_final_path, device)
